...
const GROUPS = [
  ...
  },
  {
    ...
    rows: [
      ...
      ['GET', '/api/paper', 'Paper scoreboard: forward equity vs buy-and-hold'],
      ['POST', '/api/paper/run', 'Backfill paper fills to the latest bar (run daily)'],
      ['POST', '/api/paper/retrain', 'Re-learn on extended history, promote on margin'],
